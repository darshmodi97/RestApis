    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.PositiveIntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(1, message="Age can't be less than 1.")], verbose_name='Age')),
                ...
                ('web', models.URLField(validators=[django.core.validators.URLValidator], verbose_name='Web')),
